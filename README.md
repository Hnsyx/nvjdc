...
```
wget -O Config.json  https://github.com/Hnsyx/nvjdc/raw/main/Config.json
```
国内请使用
 ```
wget -O Config.json   https://ghproxy.com/https://github.com/Hnsyx/nvjdc/raw/main/Config.json
```
